...
int CCustomWing::GetCustomWingOptionIndex(int ItemIndex,int OptionNumber) // OK
{
	...
	switch(OptionNumber)
	{
		case 0:			return lpInfo->OptionIndex1;
		case 1:			return lpInfo->OptionIndex2;
		case 2:			return lpInfo->OptionIndex3;
	}
	return 0;
}
...
int CCustomWing::GetCustomWingOptionValue(int ItemIndex,int OptionNumber) // OK
{
	...
	switch(OptionNumber)
	{
		case 0:			return lpInfo->OptionValue1;
		case 1:			return lpInfo->OptionValue2;
		case 2:			return lpInfo->OptionValue3;
	}
	return 0;
}
...
int CCustomWing::GetCustomWingNewOptionIndex(int ItemIndex,int OptionNumber) // OK
{
	...
	switch(OptionNumber)
	{
		case 0:			return lpInfo->NewOptionIndex1;
		case 1:			return lpInfo->NewOptionIndex2;
		case 2:			return lpInfo->NewOptionIndex3;
		case 3:			return lpInfo->NewOptionIndex4;
	}
	return 0;
}
...
int CCustomWing::GetCustomWingNewOptionValue(int ItemIndex,int OptionNumber) // OK
{
	...
	switch(OptionNumber)
	{
		case 0:			return lpInfo->NewOptionValue1;
		case 1:			return lpInfo->NewOptionValue2;
		case 2:			return lpInfo->NewOptionValue3;
		case 3:			return lpInfo->NewOptionValue4;
	}
	return 0;
}
